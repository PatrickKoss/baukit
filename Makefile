.PHONY: fmt lint test check ci ts-install ts-build ts-fmt ts-lint ts-test ts-check cli-fmt cli-lint cli-test cli-check cli-ci install-skills
...
ci: fmt lint test check ts-check cli-ci
