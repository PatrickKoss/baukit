...
//! # Outbox composition
//!
//! Products must copy [`POSTGRES_MIGRATION_SQL`] into their own ordered SQLx
//! migrations. The crate never runs migrations at process startup. Use
...
pub use model::{ClaimedJob, EnqueueOutcome, FailureDisposition, Job, JobStatus, NewJob};
