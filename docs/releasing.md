...
```toml
baukit-runtime = { git = "ssh://git@github.com/patrickkoss/baukit.git", tag = "baukit-v0.5.1" }
```
...
{
  "dependencies": {
    "@baukit/api-runtime": "git+ssh://git@github.com/patrickkoss/baukit.git#baukit-v0.5.1&path:typescript/packages/api-runtime"
  }
}
```
